        ...
        build_model_scorecard(
            ...
            measurements={
                ...
                "cfac": {
                    ...
                    "reason": "pilot CFAC uses exp(-mean normalized MAE) on lateral/yaw/curvature; legacy 0.4825 used dir×mag×temp on the same fields and is not longitudinal",
                },
                "a2f": {
                    "status": "fail",
                    "n": 60,
                ...
                "fau_f": {
                    "status": "missing",
                    "legacy_diagnostic_score": 0.61,
                    "n": 562,
                    "coverage": 0.9689,
                    "motion_fields": ["lateral_speed_mps", "yaw_rate_radps", "curvature_1pm"],
                    "reason": "report already shape-field FAU_F; missing until aggregation is frozen to match primary_shape_composite policy",
                },
                "fau_a": {
                    "status": "missing",
                    "legacy_diagnostic_score": 0.73,
                    "n": 562,
                    "coverage": 0.9689,
                    "motion_fields": ["lateral_speed_mps", "yaw_rate_radps", "curvature_1pm"],
                    "reason": "report already shape-field FAU_A; missing until aggregation is frozen to match primary_shape_composite policy",
                },
                "fau": {
                    "status": "missing",
                    "legacy_diagnostic_score": 0.6509,
                    "n": 562,
                    "coverage": 0.9689,
                    "aggregation": "sqrt(fau_f*fau_a)",
                    "motion_fields": ["lateral_speed_mps", "yaw_rate_radps", "curvature_1pm"],
                    "reason": "FAU components are already lateral/yaw/curvature vs private GT; missing only until formula freeze matches new CFAC policy",
                },
                "ccfc": {
                    "status": "missing",
                    "legacy_diagnostic_score": 0.1235,
                    "arc_relative_diagnostic_score": 0.2234,
                    "n": 357,
                    "coverage": 0.6155,
                    "intervention_type": "paired_command",
                    "reason": "default report still metric SE2 (0.1235); arc_relative mean 0.2234 on same 357 with direction/temporal≈0.25 — freeze shape/arc primary before ranking",
                },
                "fcs": {
                    "status": "pilot",
                    "score": 0.8086,
